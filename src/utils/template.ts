...
export const templates = [
  {
    ...
    command: 'npx get-template react my-react-app --typescript --tailwind',
  ...
  },
  {
    ...
    command: 'npx get-template react my-react-app --tailwind',
...
export const quickStartSteps = [
  {
    ...
    command: 'npx get-template react my-app --typescript --tailwind',
  },
  {
    step: '2',
